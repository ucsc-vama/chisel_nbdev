# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/03_export_scala2html.ipynb (unless otherwise specified).

__all__ = ['SCRIPT_DIR', 'HTMLParseAttrs', 'remove_widget_state', 'upd_metadata', 'hide_cells', 'clean_exports',
           'treat_backticks', 'add_jekyll_notes', 'copy_images', 'adapt_img_path', 'escape_latex', 'collapse_cells',
           'remove_hidden', 'find_default_level', 'nb_code_cell', 'SCRIPT_DIR', 'add_show_docs', 'remove_fake_headers',
