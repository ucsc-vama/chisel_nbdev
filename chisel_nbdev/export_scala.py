...
__all__ = ['read_nb', 'is_scala_nb', 'check_re', 'check_re_multi', 'is_export', 'is_non_def_export',
           'find_default_export', 'find_non_default_exports', 'find_package', 'export_names', 'reset_nbdev_module',
           'get_nbdev_module', 'save_nbdev_module', 'split_flags_and_code', 'create_mod_file', 'create_mod_files',
           'update_baseurl', 'nbglob', 'scala_notebook2script']
...
# Cell
_re_package = _mk_flag_re('package', 1, "Matches any line with //package with a package name")

# Cell
def find_package(cells):
    "Find in `cells` the name of the package."
    res = L(cells).map_first(check_re, pat=_re_package)
    return res.groups()[0] if res else None
